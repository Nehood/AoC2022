...
class Day16ProboscideaVolcaniumTest {
    ...
    @Test
    fun releaseMostPressureWithElephantTest() {
        val input = """
            Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
            Valve BB has flow rate=13; tunnels lead to valves CC, AA
            Valve CC has flow rate=2; tunnels lead to valves DD, BB
            ...
            Valve JJ has flow rate=21; tunnel leads to valve II
        """.trimIndent().lines()
        val mostPressureReleased = day16ProboscideaVolcanium.releaseMostPressureWithElephant(input)
        val expected = 1707
    ...
    @Test
    fun releaseMostPressureWithElephant() {
        val mostPressureReleased = day16ProboscideaVolcanium.releaseMostPressureWithElephant(readResourceFile())
        val expected = 2029
